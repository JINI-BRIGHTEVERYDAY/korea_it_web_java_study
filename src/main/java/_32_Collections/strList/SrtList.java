...
//        // 중복된 요소를 허용한다
        ...
        // 특정 element의 포함 여부 -> contains() 메서드 사용함 -> return boolean으로
        ...
        System.out.println("@의 포함여부는 " + isContains3);
        //String의 경우, char들이 '순서대로' 나열된 것이기 때문에 char 하나가 포함된 것을
        //contains로 부분 검색이 가능하나,
        ...
        //list의 정렬 -> 배열과 동일
        Collections.sort(strList2); // 마찬가지로 원본의 리스트를 정렬시킴
