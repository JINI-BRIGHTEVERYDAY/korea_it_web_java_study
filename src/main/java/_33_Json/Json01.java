...
//Gson
//Google Json의 약자로서, Java 객체를 Json 형태로 변환하거나 혹은 반대로 변환하는데 사용된다
//주요 클래스
//Gson - 변환을 위해 (Java 객체 <-> Json) 주로 사용되는 클래스
//GsonBuilder - Gson 인스턴스에 대한 사용자 정의 구성을 허용해준다 (prettyPrinting) 등
//JsonObject - Json 객체를 나타낸다
...
public class Json01 {
    public static void main(String[] args) {
        ...
        address.addProperty("district", "부산진구");
