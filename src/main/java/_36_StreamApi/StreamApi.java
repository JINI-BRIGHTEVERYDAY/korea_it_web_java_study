...
public class StreamApi {
    public static void main(String[] args) {
        List<String> names = Arrays.asList("김영", "김일", "김이",
                "김삼", "김사", "최오", "최육", "이칠", "박팔");
        ...
        List<String> result = englishNames.stream()
                ...
                // () -> , :: 같은 작용
                // 하지만 () -> 는 각각 요소를 매개변수로 받아서 매개변수를 참조하여 메소드를 호출하기
                // ::은 해당 타입 클래스의 메소드를 직접 호출하여 각각 요소에 적용하는 것
                .sorted() // 정렬
                .toList();
        ...
        System.out.println("이름 길이가 4 이상인 것(일반 for): " + count);
